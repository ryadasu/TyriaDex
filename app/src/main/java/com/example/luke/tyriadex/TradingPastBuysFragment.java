...
public class TradingPastBuysFragment extends Fragment {
    ...
    private class PastBuysAsyncCall extends AsyncTask<String, Void, List<TradingResult>> {

        View rootView;

        public PastBuysAsyncCall(View view) {
            rootView = view;
        }
        ...
        public List<TradingResult> doInBackground(String... params) {
            ...
            try {
                result = ApiCall.getPastBuysObject(params[0]);
        ...
        public void onPostExecute(List<TradingResult> result) {
            if (result != null) {
                ...
                if (result.size() == 0) {
                    empty.setText("No purchase history");
    ...
    public TradingPastBuysFragment() {
        //
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("LOG", "Trading Past Buys Fragment load api key: " + apiKey);
        ...
        PastBuysAsyncCall asyncSales = new PastBuysAsyncCall(rootView);
