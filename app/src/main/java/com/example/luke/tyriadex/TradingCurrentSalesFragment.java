...
public class TradingCurrentSalesFragment extends Fragment {
    ...
    private class CurrentSalesAsyncCall extends AsyncTask<String, Void, List<TradingResult>> {

        View rootView;

        public CurrentSalesAsyncCall(View view) {
            rootView = view;
        }
        ...
        public List<TradingResult> doInBackground(String... params) {
            ...
            try {
                result = ApiCall.getCurrentSalesObject(params[0]);
        ...
        public void onPostExecute(List<TradingResult> result) {
            if (result != null) {
                ...
                if (result.size() == 0) {
                    empty.setText("No current sales listings");
    ...
    public TradingCurrentSalesFragment() {
        //
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("LOG", "Trading Current Sales Fragment load api key: " + apiKey);
        ...
        CurrentSalesAsyncCall asyncSales = new CurrentSalesAsyncCall(rootView);
