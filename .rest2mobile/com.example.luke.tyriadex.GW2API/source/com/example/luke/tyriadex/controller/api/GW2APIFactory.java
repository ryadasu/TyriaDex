...
public class GW2APIFactory extends ControllerFactory<GW2API> {
  ...
  public static class GW2APISchemaFactory extends AbstractControllerSchemaFactory {
    ...
    protected synchronized void initSchemaMaps() {
      ...
      JMethod method2 = addMethod("getBank",
        "v2/account/bank",
        "GET",
        List.class,
        BankResult.class,
      ...
      JMethod method3 = addMethod("getCharacterByName",
      ...
      method3.addParam("characterName",
        "TEMPLATE",
        String.class,
        null,
        "",
      ...
      JMethod method4 = addMethod("getCharacterNames",
        "v2/characters",
        "GET",
        List.class,
        String.class,
      ...
      JMethod method5 = addMethod("getCurrencyById",
      ...
      JMethod method6 = addMethod("getCurrentBuys",
      ...
      JMethod method7 = addMethod("getCurrentSales",
      ...
      JMethod method8 = addMethod("getDelivery",
      ...
      JMethod method9 = addMethod("getItemById",
        "v2/items/{itemID}",
        "GET",
      ...
      JMethod method10 = addMethod("getPastBuys",
      ...
      method10.addParam("access_token",
        "QUERY",
        String.class,
        null,
        "",
      ...
      JMethod method11 = addMethod("getPastSales",
      ...
      JMethod method12 = addMethod("getWallet",
        "v2/account/wallet",
        "GET",
        List.class,
        WalletResult.class,
